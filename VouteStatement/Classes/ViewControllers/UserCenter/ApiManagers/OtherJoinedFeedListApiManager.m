//
//  OtherJoinedFeedListApiManager.m
//  VouteStatement
//
...
@interface OtherJoinedFeedListApiManager ()<VTApiManager,VTAPIManagerValidator>

@property (nonatomic,strong)NSString *uid;

@end

@implementation OtherJoinedFeedListApiManager
...
- (NSString *)methodName {
    ...
    return [NSString stringWithFormat:@"/v1/users/%@/joined",self.uid];
}
